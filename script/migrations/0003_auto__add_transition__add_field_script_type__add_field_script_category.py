...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.create_table('script_transition', (
            ('id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('from_step', self.gf('django.db.models.fields.related.ForeignKey')(related_name='from', to=orm['script.ScriptStep'])),
            ('to_step', self.gf('django.db.models.fields.related.ForeignKey')(related_name='to', to=orm['script.ScriptStep'])),
            ('event', self.gf('script.fields.JSONField')(default={})),
        ))
        db.send_create_signal('script', ['Transition'])

        # Adding field 'Script.type'
        db.add_column('script_script', 'type',
                      self.gf('django.db.models.fields.IntegerField')(default=1, null=True),
                      keep_default=False)

        # Adding field 'Script.category'
        db.add_column('script_script', 'category',
                      self.gf('django.db.models.fields.IntegerField')(default=3, null=True),
                      keep_default=False)

    def backwards(self, orm):
        # Deleting model 'Transition'
        db.delete_table('script_transition')

        # Deleting field 'Script.type'
        db.delete_column('script_script', 'type')

        # Deleting field 'Script.category'
        db.delete_column('script_script', 'category')
    ...
    models = {
        ...
        'script.script': {
            ...
            'category': ('django.db.models.fields.IntegerField', [], {'default': '3', 'null': 'True'}),
            'enabled': ('django.db.models.fields.BooleanField', [], {'default': 'True'}),
            'name': ('django.db.models.fields.CharField', [], {'max_length': '128'}),
            'sites': ('django.db.models.fields.related.ManyToManyField', [], {'to': "orm['sites.Site']", 'symmetrical': 'False'}),
            'slug': ('django.db.models.fields.SlugField', [], {'max_length': '64', 'primary_key': 'True'}),
            'type': ('django.db.models.fields.IntegerField', [], {'default': '1', 'null': 'True'})
        },
        ...
        'script.transition': {
            ...
            'event': ('script.fields.JSONField', [], {'default': '{}'}),
            'from_step': ('django.db.models.fields.related.ForeignKey', [], {'related_name': "'from'", 'to': "orm['script.ScriptStep']"}),
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'to_step': ('django.db.models.fields.related.ForeignKey', [], {'related_name': "'to'", 'to': "orm['script.ScriptStep']"})
        },
        'sites.site': {
